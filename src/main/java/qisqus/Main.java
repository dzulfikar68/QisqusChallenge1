...
public class Main {
    public static void main(String[] args) {
        ...
        */
        List<Book> availableBooks = fictionBookLibrary.listAvailableBooks();
        ...
        */
        List<Book> booksByArthurConanDoyle = fictionBookLibrary.listBooksAuthoredBy("Arthur Conan Doyle");
        ...
        */
        List<Book> borrowedByJohn = john.listBorrowedBooks();
        ...
        */
        ...
        'The Two Towers'".
        */
        List<Book> borrowedByJane = jane.listBorrowedBooks();
...
class FictionBookLibrary {
    ...
    public Member createMember(String member) {
        Member obj = new Member(member);
        obj.setLibrary(this);
        if (!members.contains(obj)) members.add(obj);
        return obj;
    }

    public void addCollection(Book book, int items) {
        if (items == 1) {
            books.add(book);
        } else if (items > 1) {
...
class Member {
    // PLACE YOUR CODE HERE
    public FictionBookLibrary library;
    public String name;
    ...
    public void setLibrary(FictionBookLibrary library) {
